...
if __name__ == '__main__':
    ...
    print(f"Result with token: {hug_fs.exists(f'{repo_name}/hf_test/.gitattributes')} And Result with no token: {hug_fs_sec.exists(f'{repo_name}/hf_test/.gitattributes')} And Result with HfApi: {hugApi_fs.file_exists(f'{repo_name}/hf_test', filename='.gitattributes', repo_type='model')}")
